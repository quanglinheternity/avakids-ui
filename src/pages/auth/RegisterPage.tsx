...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Using api.post as we've fixed the redirect in api.ts
                                            ...
                                            <div className="w-full" aria-live="polite">
                                                ...
                                                <div className="relative mb-[16px]">
                                                    <input
                                                        ...
                                                        placeholder=" "
                                                        className="peer w-full rounded-[16px] border border-gray-300 bg-white px-[16px] py-[12px] text-[16px] focus:border-primary-400 focus:outline-none hover:border-primary-400"
                                                    />
                                                    <label
                                                        htmlFor="fullName"
                                                        className="absolute left-[16px] top-[12px] z-10 origin-[0] transform text-gray-500 duration-300 pointer-events-none peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-4 peer-focus:scale-75 peer-not-placeholder-shown:-translate-y-4 peer-not-placeholder-shown:scale-75 peer-focus:text-primary-400"
                                                    >
                                                        Họ và tên...
                                                    </label>
                                                </div>
